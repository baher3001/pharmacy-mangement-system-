...
<?php 
    ...
    if(isset($_GET['error']))
    {
        echo "<div class='alert alert-danger text-center'>  you have to login first     </div>";
...
<nav>
    <div class="container">
        ...
        <div class="nav-content">
            <ul>
                <li>
                    <a href="http://localhost/php/pharmacy/admin/login.php" class="btn btn-primary"> Sign in  </a>
                </li>
            </ul>
        </div>
        ...
        <div class="container">
            <form action="signup1.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-control" placeholder="Enter your Phone here " required>
                    <small> Please Enter your Phone  here  </small>
                ...
                <div class="form-group">
                    <input type="submit"  name="sign" value="sign" class="btn btn-primary btn-block">
                </div>
    ...
    <section class="log">
        ...
        <div class="container">
            <form action="login1.php" method="POST">
                ...
                <div class="form-group">
                    <input type="submit" value="login"  name="log" class="btn btn-danger btn-block">
                </div>
